 ...
 * nombre de usuario (login) de una cuenta ya existente. Los mismos 3
 * campos (`usuario`, `placa`, `estado`) y sus restricciones se copian 1:1
 * de `CreateUsuarioDto.usuario` y `CreatePerfilMotorizadoDto` — ninguna
 * regla nueva, solo la forma de fila que el archivo puede expresar.
 *
